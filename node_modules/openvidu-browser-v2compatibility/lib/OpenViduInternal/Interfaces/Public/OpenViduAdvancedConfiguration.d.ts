...
export interface OpenViduAdvancedConfiguration {
    ...
    /**
     * Custom configuration for the {@link PublisherSpeakingEvent} feature and the [StreamManagerEvent.streamAudioVolumeChange](/en/stable/api/openbidu-browser-v2compatibility/classes/StreamManagerEvent.html) feature. It is an object which includes the following optional properties:
    ...
    /**
     * The milliseconds that must elapse after triggering {@link ExceptionEvent} of name [`ICE_CONNECTION_DISCONNECTED`](/en/stable/api/openbidu-browser-v2compatibility/enums/ExceptionEventName.html#ICE_CONNECTION_DISCONNECTED) to perform an automatic reconnection process of the affected media stream.
    ...
    /**
     * The milliseconds that must elapse for the {@link ExceptionEvent} of name [`NO_STREAM_PLAYING_EVENT`](/en/stable/api/openbidu-browser-v2compatibility/enums/ExceptionEventName.html#NO_STREAM_PLAYING_EVENT) to be fired.
     *
     * Default to `4000`.
     */
